...
module.exports = denarabot = async (denarabot, mek, _welkom) => {
	try {
		...
		let botNumber = denarabot.user.jid
		let ownerNumber = [`${owner}@s.whatsapp.net`, `6285157740529@s.whatsapp.net`]
		let isGroup = from.endsWith('@g.us')
		let sender = isGroup ? mek.participant : mek.key.remoteJid
		let totalchat = await denarabot.chats.all()
		let groupMetadata = isGroup ? await denarabot.groupMetadata(from) : ''
		...
		let conts = mek.key.fromMe ? denarabot.user.jid : denarabot.contacts[sender] || { notify: jid.replace(/@.+/, '') }
        let pushname = mek.key.fromMe ? denarabot.user.name : conts.notify || conts.vname || conts.name || '-'
...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			...
			success: 'Done Jangan Lupa Subscribe Denara Bot',
			error: {
        ...
        let reply = (teks) => {
            denarabot.sendMessage(from, teks, text, {quoted:mek})
        }
        let sendMess = (hehe, teks) => {
            denarabot.sendMessage(hehe, teks, text)
        }
        let mentions = (teks, memberr, id) => {
            (id == null || id == undefined || id == false) ? denarabot.sendMessage(from, teks.trim(), extendedText, { contextInfo: { "mentionedJid": memberr } }) : denarabot.sendMessage(from, teks.trim(), extendedText, { quoted: ftrol, contextInfo: { "mentionedJid": memberr } })
        }
        let zero = fs.readFileSync ('./denarabot/denarathumb.jpg')
        let costum = (pesan, tipe, target, target2) => {
			denarabot.sendMessage(from, pesan, tipe, { quoted: { key: { fromMe: false, participant: `${target}`, ...(from ? { remoteJid: from } : {}) }, message: { conversation: `${target2}` } } })
		}
		let katalog = (teks) => {
             res = denarabot.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 111119999, "message": teks, "footerText": `*${ownername}*`, "thumbnail": fs.readFileSync('./denarabot/denara.jpg'), "surface": 'CATALOG' }}, {quoted:ftrol})
             denarabot.relayWAMessage(res)
        }
...
//━━━━━━━━━━━━━━━[ BUTTON ]━━━━━━━━━━━━━━━━━//
        ...
        let sendButton = async (from, context, fortext, but, mek) => {
            ...
            denarabot.sendMessage(from, buttonMessages, buttonsMessage, {
                quoted: ftrol
            })
        }
        let sendButImage = async (from, context, fortext, img, but, mek) => {
            jadinya = await denarabot.prepareMessage(from, img, image)
            buttonMessagesI = {
...
//━━━━━━━━━━━━━━━[ CONNECTION 2 ]━━━━━━━━━━━━━━━━━//
        ...
        let sendStickerFromUrl = async(to, url) => {
                ...
                download(url, './stik' + names + '.png', async function () {
                    ...
                    exec(`ffmpeg -i ${filess} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${asw}`, (err) => {
                        ...
                        denarabot.sendMessage(to, media, MessageType.sticker,{quoted:mek})
        ...
        let sendMediaURL = async(to, url, text="", mids=[]) =>{
                ...
                download(url, filename, async function () {
                    ...
                    denarabot.sendMessage(to, media, type, { quoted: ftrol, mimetype: mime, caption: text,contextInfo: {"mentionedJid": mids}})
...
setTimeout(() => {
denarabot.groupRemove(from, [kic]).catch((e) => { reply(`BOT HARUS JADI ADMIN`) })
}, 0)
}
...
denarabot.groupRemove(from, [sender])
}     
if (isCmd && !isUser){
...
switch (command) {
	...
	gambar = fs.readFileSync('./denarabot/denara.jpg')
	menu = `𝙃𝙖𝙮 ${pushname} ${tampilUcapan}

✉️ 𝙎𝙤𝙪𝙧𝙘𝙚 𝙘𝙤𝙙𝙚 = Beli Ketik #owner
👤 𝘼𝙪𝙩𝙝𝙤𝙧 = Denara Bot
🌍 𝙇𝙞𝙗 = Baileys
...
denarabot.groupSettingChange(from, GroupSettingChange.messageSend, false)
break
case 'grouptutup' :
if (!isGroup) return reply(mess.only.group)
if (!isGroupAdmins) return reply(mess.only.admin)
...
denarabot.groupSettingChange(from, GroupSettingChange.messageSend, true)
break
case 'linkgrup' :
if (!isGroup) return reply(mess.only.group)
if (!isBotGroupAdmins) return reply("Bot Bukan Admin :)")
linkgc = await denarabot.groupInviteCode(from)
yeh = `https://chat.whatsapp.com/${linkgc}\n\nlink Group *${groupName}*`
denarabot.sendMessage(from, yeh, text, { quoted: ftrol })
break
case 'promote' :
if (!isGroup) return reply(mess.only.group)
if (!isGroupAdmins) return reply(mess.only.admin)
...
denarabot.groupMakeAdmin(from, mentioned)
} else {
...
mentions(teks, mentioned, true)
denarabot.groupDemoteAdmin(from, mentioned)
} else {
...
mentions(teks, mentioned, true)
denarabot.groupRemove(from, mentioned)
} else {
...
if (!isGroupAdmins) return reply(mess.only.admin)
if (!isBotGroupAdmins) return reply(mess.only.Badmin)
denarabot.groupUpdateSubject(from, `${body.slice(9)}`)
denarabot.sendMessage(from, `\`\`\`✓Sukses Mengganti Nama Group Menjadi\`\`\` *${body.slice(9)}*`, text, { quoted: ftrol })
break
case 'setdesc':
if (!isGroup) return reply(mess.only.group)
if (!isGroupAdmins) return reply(mess.only.admin)
if (!isBotGroupAdmins) return reply(mess.only.Badmin)
denarabot.groupUpdateDescription(from, `${body.slice(9)}`)
denarabot.sendMessage(from, `\`\`\`✓Sukses Mengganti Deskripsi Group\`\`\` *${groupMetadata.subject}* Menjadi: *${body.slice(9)}*`, text, { quoted: ftrol })
break
case 'setpp':
if (!isGroup) return reply(mess.only.group)
if (!isGroupAdmins) return reply(mess.only.admin)
if (!isBotGroupAdmins) return reply(mess.only.Badmin)
media = await denarabot.downloadAndSaveMediaMessage(mek, './database/media_user')
await denarabot.updateProfilePicture(from, media)
reply(mess.wait)
...
var group = await denarabot.groupMetadata(from)
...
denarabot.sendMessage(from, options, text)
break
...
denarabot.sendMessage(from, buffer, sticker, { quoted: ftrol })
break
case 'sticker':
case 'stiker':
case 's':
...
let media = await denarabot.downloadAndSaveMediaMessage(encmedia, './database/media_user')
ran = getRandom('.webp')
await ffmpeg(`./${media}`)
.input(media)
...
costum(buffer, sticker, Verived, `Jangan Lupa Subscribe Denara Bot`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
denarabot.sendMessage(from, fs.readFileSync(ranw), sticker, { quoted: ftrol })
fs.unlinkSync(ranw)
})
})
} else {
...
media = await denarabot.downloadAndSaveMediaMessage(encmedia, './database/media_user')
ran = getRandom('.png')
exec(`ffmpeg -i ${media} ${ran}`, (err) => {
fs.unlinkSync(media)
if (err) return reply(' Gagal, pada saat mengkonversi sticker ke gambar ')
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `Jangan Lupa Subscribe Denara Bot`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
denarabot.updatePresence(from, Presence.recording)
...
denarabot.sendMessage(from, bufferlkj, audio, { mimetype: 'audio/mp4', quoted: ftrol })
fs.unlinkSync(ran)
})
break
case 'tovideo':
...
anum = await denarabot.downloadAndSaveMediaMessage(anumedia, './database/media_user')
ran = getRandom('.webp')
exec(`ffmpeg -i ${anum} ${ran}`, (err) => {
fs.unlinkSync(anum)
buffer = fs.readFileSync(ran)
denarabot.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Done... Jangan Lupa Subscribe Denara Bot' })
fs.unlinkSync(ran)
})
break
...
let vname = denarabot.contacts[i] != undefined ? denarabot.contacts[i].vname || denarabot.contacts[i].notify : undefined
inilist.push({
"displayName": 'Denara Bot',
"vcard": 'BEGIN:VCARD\n'
+ 'VERSION:3.0\n'
+ `FN:${ownername}\n`
...
await denarabot.sendMessage(_.jid, btnbc, MessageType.buttonsMessage, {quoted: ftrol})
}
...
denarabot.sendMessage(`6285727492435@s.whatsapp.net`, options, text, { quoted: ftrol })
reply('Masalah Telah Di Laporkan Ke Owner BOT, Mohon Tunggu Untuk Proses Perbaikan')
break
case 'youtube':
teks =
`Nih Youtube Owner Ku Jangan Lupa Di Subscribe Ya https://youtube.com/DenaraBot`
denarabot.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'instagram':
teks =
...
case "belah":
				if (args.length < 1) return reply('mana pertanyaan nya kak?\nContoh zero bermain Free Fire')
					...
					denarabot.sendMessage(from, 'Pertanyaan : *bener atau salah '+iyas+'*\n\nJawaban : '+ salah, text, { quoted: ftrol })
					break
		            case "bagaimanakah":
  ...
  gayy = body.slice(1)
            ...
            sendButMessage(from, `Mau main lagi?`, `Pencet tombol di bawah`, [
          {
            ...
            case "say":
              ...
              saying = teks
                 denarabot.sendMessage(from, saying, text)
              break
              case "caklontong":
   ...
   setTimeout( () => {
   denarabot.sendMessage(from, cak, text, {quoted: ftrol }) // ur cods
   }, 0) // 1000 = 1s,
   break
   case "lesbicek":
					...
					denarabot.sendMessage(from, 'Pertanyaan : *'+lesbii+'*\n\nJawaban : '+ bi+'%', text, { quoted: ftrol })
					break
					case "watak":
					...
					denarabot.sendMessage(from, 'Pertanyaan : *'+watak+'*\n\nJawaban : '+ tak, text, { quoted: ftrol })
				        break
				case "hobby":
					...
					denarabot.sendMessage(from, 'Pertanyaan : *'+hobby+'*\n\nJawaban : '+ by, text, { quoted: ftrol })
					break
					case "truth":
...
//━━━━━━━━━━━━━━━[ FITUR MAKER ]━━━━━━━━━━━━━━━━━//
        ...
        if (
          ...
          //  console.log(ted)
          reply("Loading.....");
          owgi = await denarabot.downloadAndSaveMediaMessage(ted);
          console.log(owgi);
          ...
          denarabot.sendMessage(from, hehe, image, {
            quoted: ftrol,
        ...
        denarabot.sendMessage(from, rakz, image, {
          quoted: ftrol,
          thumbnail: Buffer.alloc(0),
        });
        break;
        ...
        case "googlem":
				...
				if (args.length < 1) return reply(`Teksnya Mana Tod ?\nContoh: ${prefix + command}Denara Bot | ganteng | banget`)
				reply(mess.wait)
kontol = body.slice(8)
...
shit = `${anu.result.url}\n${anu.result.info}`
denarabot.sendMessage(from, buffer, image, {quoted: ftrol, caption: shit, thumbnail: Buffer.alloc(0)})
break
case "roses":
...
if (args.length < 1) return reply(`Teksnya Mana Tod ?\nContoh: ${prefix + command}Denara Bot`)
				...
				denarabot.sendMessage(from, asu, image, {quoted: ftrol, thumbnail: Buffer.alloc(0)})
				break
				case "halloween":
					if (args.length < 1) return reply(`Teksnya Mana Tod ?\nContoh: ${prefix + command}Denara Bot`)
					biji = body.slice(11)
					...
					denarabot.sendMessage(from, atetepe, image, { quoted: ftrol, thumbnail: Buffer.alloc(0) })
					break
					case "minion":
					if (args.length < 1) return reply(`Teksnya Mana Tod ?\nContoh: ${prefix + command}Denara Bot'`)
					biji = body.slice(8)
...
//━━━━━━━━━━━━━━━[ FITUR OTHER ]━━━━━━━━━━━━━━━━━//
   ...
   case 'shortlink':
				denarabot.updatePresence(from, Presence.composing) 
...
encmediam = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
					mediam = await denarabot.downloadAndSaveMediaMessage(encmediam)
					cokmatane = Number(args[0])
					hah = fs.readFileSync(mediam)
						denarabot.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', duration: cokmatane, ptt: true, quoted:ftrol})
						fs.unlinkSync(mediam)
				break
				case 'detikvideo':
				encmedian = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
					median = await denarabot.downloadAndSaveMediaMessage(encmedian)
					cokmatane = Number(args[0])
					hah = fs.readFileSync(median)
						denarabot.sendMessage(from, hah, video, {mimetype: 'video/mp4', duration: cokmatane, quoted: ftrol})
						fs.unlinkSync(median)
				break
				case 'delete':
					denarabot.deleteMessage(from, { id: mek.message.extendedTextMessage.contextInfo.stanzaId, remoteJid: from, fromMe: true })
					break
					case 'infogempa':
					...
					denarabot.sendMessage(from, buff, image, {quoted: ftrol, caption: gempa})
					break
					case 'dadu':
			random = Math.floor(Math.random() * 6) + 1
		damdu = fs.readFileSync(`./sticker/${random}.webp`)
			denarabot.sendMessage(from, damdu, sticker, {quoted: ftrol})
			break
			case "caripesan":
        case "smsg":
        if (!q) return reply("pesannya apa bang?");
        let v = await denarabot.searchMessages(q, from, 10, 1);
        let s = v.messages;
        ...
        try {
          ...
          for (let i = 0; i < el.length; i++) {
            await denarabot.sendMessage(from, "Nih pesannya", text, {
              quoted: el[i],
            });
          }
        } catch (e) {
      ...
      case "googleimage":
          ...
          .then((body) => {
            ...
            imageToBase64(pjr)
              .then((response) => {
                ...
                denarabot.sendMessage(from, media, image, {
                  quoted: ftrol,
                  caption: "NIH",
                });
              })
        ...
        await denarabot.sendMessage(from, di, image, { quoted: mek })
        break;
        case "lirik":
...
break
case "chara":
        if (!q) return reply(`gambar apa?\n${prefix}chara Denara Bot`);
        let im = await hx.chara(q);
        let acak = im[Math.floor(Math.random() * im.length)];
        let li = await getBuffer(acak);
        await denarabot.sendMessage(from, li, image, { quoted: ftrol });
        break;
        case "playstore":
...
//━━━━━━━━━━━━━━━[ FITUR RANDOM IMAGE ]━━━━━━━━━━━━━━━━━//
      ...
      case "aeshtetic":
      case "wallpaperanime":
      sendButton(from, `Random Image By Denara Bot`, `press the button below`, [
          {
...
await denarabot.sendMessage(from, ini_buffer, audio, { quoted: ftrol, mimetype: Mimetype.mp4Audio })
break
case 'asmaulhusna':
...
await denarabot.sendMessage(from, ini_buffer, image, { quoted: ftrol, caption: caption })
get_audio = await getBuffer(result.link)
await denarabot.sendMessage(from, get_audio, audio, { mimetype: 'audio/mp4', filename: `${result.title}.mp3`, quoted: ftrol})
})
})
break
case "playvideo":
...
await denarabot.sendMessage(from, ini_buffer, video, { quoted: ftrol, caption: 'Done...!!!'})
break
case 'tiktokmusic':
if (args.length == 0) return reply(`Link Nya Mana Tod\nContoh: ${prefix + command} https://vt.tiktok.com/ZSwWCk5o/`)
ini_link = args[0]
get_audio = await getBuffer(`https://api.lolhuman.xyz/api/tiktokmusic?apikey=${zerokey}&url=${ini_link}`)
await denarabot.sendMessage(from, get_audio, audio, { mimetype: Mimetype.mp4Audio, quoted: ftrol})
break
case 'pinterest':
...
await denarabot.sendMessage(from, ini_buffer, image, { quoted: ftrol, caption: 'Done...!!!'})
break
case 'instagram':
case 'ig':
case 'igdl': 
...
denarabot.sendMessage(from, {url: res.result}, video, {quoted: ftrol})
})
break
...
case 'asupan':
ini = await fetchJson(`https://denarabot-api.herokuapp.com/api/asupan?apikey=${zerkey}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.result)
denarabot.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Done...!!!', thumbnail: Buffer.alloc(0)})
break
case 'asupancecan':
ini = await fetchJson(`https://denarabot-api.herokuapp.com/api/asupan/cecan?apikey=${zerkey}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
denarabot.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'Done...!!!', thumbnail: Buffer.alloc(0)})
break
case 'asupanhijaber':
ini = await fetchJson(`https://denarabot-api.herokuapp.com/api/asupan/hijaber?apikey=${zerkey}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
denarabot.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'Done...!!!', thumbnail: Buffer.alloc(0)})
break
case 'asupansantuy':
ini = await fetchJson(`https://denarabot-api.herokuapp.com/api/asupan/santuy?apikey=${zerkey}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
denarabot.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Done...!!!', thumbnail: Buffer.alloc(0)})
break
case 'asupanukhti':
ini = await fetchJson(`https://denarabot-api.herokuapp.com/api/asupan/ukty?apikey=${zerkey}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
denarabot.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Done...!!!', thumbnail: Buffer.alloc(0)})
break
case 'asupanbocil':
ini = await fetchJson(`https://denarabot-api.herokuapp.com/api/asupan/bocil?apikey=${zerkey}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
denarabot.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Done...!!!', thumbnail: Buffer.alloc(0)})
break
case 'asupanghea':
ini = await fetchJson(`https://denarabot-api.herokuapp.com/api/asupan/ghea?apikey=${zerkey}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
denarabot.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Done...!!!', thumbnail: Buffer.alloc(0)})
break
case 'asupanrika':
ini = await fetchJson(`https://denarabot-api.herokuapp.com/api/asupan/rikagusriani?apikey=${zerkey}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
denarabot.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Done...!!!', thumbnail: Buffer.alloc(0)})
break
...
if (args.length < 1) return reply('Teksnya?')
teks = body.slice(10)
denarabot.sendMessage('status@broadcast', teks, MessageType.text)
...
buff = await denarabot.downloadMediaMessage(encmedia)
denarabot.sendMessage('status@broadcast', buff, sticker)
}
...
buff = await denarabot.downloadMediaMessage(encmedia)
denarabot.sendMessage('status@broadcast', buff, audio, {mimetype: 'audio/mp4', duration: 359996400})
}
...
var mediap = await denarabot.downloadAndSaveMediaMessage(enmediap)
const buffer3 = fs.readFileSync(mediap)
denarabot.sendMessage('status@broadcast', buffer3, MessageType.video, {duration: 359996400, caption: `${konti}`})
...
media = await denarabot.downloadAndSaveMediaMessage(enmedia)
buffer = fs.readFileSync(media)
denarabot.sendMessage('status@broadcast', buffer, MessageType.image, {quoted: mek, caption: `${teksyy}`})
...
await denarabot.sendMessage(from, get_buffer, image, { quoted: ftrol, caption: ini_txt })
break
case 'cuaca':
...
await denarabot.sendMessage(from, { degreesLatitude: get_result.latitude, degreesLongitude: get_result.longitude }, location, { quoted: ftrol })
reply(ini_txt)
break
case 'covidindo':
...
denarabot.sendMessage(from, ini_buffer, image, { caption: ini_txt })
break
case 'stalktiktok':
if (args.length == 0) return reply(`Usernamenya Mana Tod\nContoh: ${prefix + command} Sandrinna`)
stalk_toktok = args[0]
get_result = await fetchJson(`https://api.lolhuman.xyz/api/stalktiktok/${stalk_toktok}?apikey=denarabot`)
get_result = get_result.result
...
denarabot.sendMessage(from, pp_tt, image, { quoted: ftrol, caption: ini_txt })
break
case 'stalkgithub':
...
reply(mess.wait)
denarabot.sendMessage(from, gambar, image, { quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Denara Bot'})
})
break
default:
if (isOwner) {
			if (budy.startsWith('>')) {
				...
				try {
					return denarabot.sendMessage(from, JSON.stringify(eval(budy.slice(2)), null, '\t'), text, { quoted: ftrol })
				} catch (err) {
					e = String(err)
					reply(e)
				}
